...
[**받으러 가기**](https://doran-doran-desktop.vercel.app/) · [English](https://doran-doran-desktop.vercel.app/en/)
...
도란도란(영어로는 **Doran Doran**)은 그 사이를 채웁니다. 내가 내 캐릭터를 톡 누르면, 멀리 있는 친구의 바탕화면
...
> 같은 안내가 [홈페이지](https://doran-doran-desktop.vercel.app/#install)에도 그림과 함께
> 있습니다. 둘 중 편한 쪽을 보세요.
...
<div align="center">
<img src="apps/web/public/assets/team-window.webp" alt="방 목록이 열려 있는 도란도란 창" width="420">
</div>
...
**새 버전은 어떻게 받나요?**
Windows 는 조용히 받아 뒀다가 알려 줍니다. macOS 는 코드 서명이 없어서 자동 업데이트가
...
둘러보려면 `DORAN_FAKE_NET=1 npm start` 로 가짜 서버를 쓸 수도 있어요.
