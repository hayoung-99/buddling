...
export const ko: Copy = {
  ...
  shot: {
    ...
    imageAlt: '방 목록이 열려 있는 도란도란 창. 나오리와 친구들 한 개에 멤버 한 명이 접속해 있다.',
  },
  ...
  meta: {
    title: '도란도란 · 친구들과 함께 쓰는 무료 바탕화면 캐릭터 앱',
    description:
