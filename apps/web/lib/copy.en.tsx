...
export const en: Copy = {
  ...
  shot: {
    ...
    imageAlt: 'The Doran Doran window with a team list open, showing one team with one teammate online.',
  },
  ...
  install: {
    ...
    macos: {
      title: 'macOS',
      howToName: 'Open Doran Doran for the first time on macOS',
      steps: [
    ...
    windows: {
      title: 'Windows',
      howToName: 'Install Doran Doran on Windows',
      steps: [
  ...
  footer: {
    tagline: 'Doran Doran · Free to use and to change',
    github: 'GitHub',
    releases: 'Releases',
  },
  ...
  meta: {
    title: 'Doran Doran · A free desktop pet your teammates can feel',
    description:
